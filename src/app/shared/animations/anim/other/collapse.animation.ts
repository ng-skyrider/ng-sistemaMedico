import { animate, animation, AnimationTriggerMetadata, AUTO_STYLE, keyframes, state, style, transition, trigger } from '@angular/animations';
...
import { animateIncludingChildren } from './animate-including-children';
...
const fadeOutCollapseLeft = () =>
  ...
  export const collapseAnimation = (options?: IAnimationOptions): AnimationTriggerMetadata =>{
  ...
  export const collapseHorizontallyAnimation = (options?: IAnimationOptions): AnimationTriggerMetadata => {
